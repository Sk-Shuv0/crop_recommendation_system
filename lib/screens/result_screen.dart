...
class ResultScreen extends StatelessWidget {
  ...
  String getDescription(String crop) {
    switch (crop.toLowerCase()) {
      ...
      case "muskmelon":
        return "বাঙ্গি বা মাস্কমেলন একটি গ্রীষ্মকালীন ফল যা উষ্ণ ও শুষ্ক আবহাওয়ায় ভালো জন্মে। "
            "এটি বেলে দোআঁশ মাটিতে ভালো ফলন দেয় এবং পর্যাপ্ত সূর্যালোক প্রয়োজন হয়। "
            "বাঙ্গিতে প্রচুর ভিটামিন A, C, পটাশিয়াম ও অ্যান্টিঅক্সিডেন্ট রয়েছে যা শরীরের জন্য উপকারী।";
  ...
  String getFertilizer(String crop) {
    switch (crop.toLowerCase()) {
      ...
      case "muskmelon":
        return "জৈব সার, ইউরিয়া, টিএসপি ও এমওপি সুষমভাবে প্রয়োগ করতে হবে।";
      default:
